...
public class msg_video_stream_status extends MAVLinkMessage {
     ...
     */
    public msg_video_stream_status( float framerate, long bitrate, int flags, int resolution_h, int resolution_v, int rotation, int hfov, short stream_id, short camera_device_id) {
        this.msgid = MAVLINK_MSG_ID_VIDEO_STREAM_STATUS;
     ...
     */
    public msg_video_stream_status( float framerate, long bitrate, int flags, int resolution_h, int resolution_v, int rotation, int hfov, short stream_id, short camera_device_id, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_VIDEO_STREAM_STATUS;
        this.sysid = sysid;
        this.compid = compid;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_VIDEO_STREAM_STATUS - sysid:"+sysid+" compid:"+compid+" framerate:"+framerate+" bitrate:"+bitrate+" flags:"+flags+" resolution_h:"+resolution_h+" resolution_v:"+resolution_v+" rotation:"+rotation+" hfov:"+hfov+" stream_id:"+stream_id+" camera_device_id:"+camera_device_id+"";
    }
