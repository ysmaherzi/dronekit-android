...
public class CAMERA_CAP_FLAGS {
   ...
   public static final int CAMERA_CAP_FLAGS_HAS_THERMAL_RANGE = 4096; /* Camera supports absolute thermal range (request CAMERA_THERMAL_RANGE with MAV_CMD_REQUEST_MESSAGE) (WIP). | */
